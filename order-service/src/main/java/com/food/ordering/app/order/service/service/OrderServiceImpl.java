...
public class OrderServiceImpl implements OrderService {
  ...
  @Override
  @Cacheable(value = "orderDetails", key = "{#orderId}") // TODO: might cause security issues
  ...
  @Override
  @Transactional
  @CacheEvict(value = "orderDetails", key = "{#orderId}", beforeInvocation = true)
  ...
  @CacheEvict(value = "orderDetails", key = "{#ticketId}", beforeInvocation = true)
