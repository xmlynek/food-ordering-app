        ...
        <Row justify="space-around" align="middle" gutter={[16, 16]}>
          <Col span={8} order={1} xs={24} sm={12} md={8} lg={8} xl={8} className={styles.column}>
            <Space direction="vertical" size="middle" className={styles.spaceVertical}>
              <Text className={styles.footerTitle} strong>Delivery Management Application</Text>
              <Text className={styles.footerText}>The best delivery management system.</Text>
            </Space>
          </Col>
          ...
          <Col span={8} xs={{span: 24, order: 3}} sm={{span: 24, order: 3}}
            ...
            <Text className={styles.footerText}>&copy; {currentYear} Filip Mlýnek - Delivery Management Application</Text>
          </Col>
