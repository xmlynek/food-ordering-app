...
public record MenuItemUpdateRequest(@NotBlank(message = "Menu name can not be blank") String name,
                                    @NotBlank(message = "Menu description can not be blank") String description,
                                    @NotNull(message = "Menu availability can not be null") Boolean isAvailable,
